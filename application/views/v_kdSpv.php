<div id="portfolio-page" class="portfolio-page-content">
    <div class="container">
        ...
        <div class="portfolio-title">
            <h1>Kriteria Dasar Supervisor</h1>
        </div>
        ...
        <div class="row">
            <div class="col-sm-7 col-md-7 portfolio-block">
                <div class="owl-carousel portfolio-page-carousel">
                    ...
                    <div class="item">
                        <img src="<?= base_url() ?>template/tema1/images/portfolio/kriteria/kd sv2nn.jpg" alt="">
                    </div>
                    <div class="item">
                        <img src="<?= base_url() ?>template/tema1/images/portfolio/kriteria/kd sv3nn.jpg" alt="">
                    </div>
                </div>
            ...
            <div class="col-sm-5 col-md-5 portfolio-block">
                ...
                <ul class="project-general-info">
                    <li><p><i class="fa fa-user"></i> Kriteria Dasar Supervisor</p></li>
