        ...
        <div class="row">
            <div class="col-sm-7 col-md-7 portfolio-block">
                <div class="owl-carousel portfolio-page-carousel">
                    <div class="item">
                        <img src="<?= base_url() ?>template/tema1/images/portfolio/training/2.jpg" alt="">
                    </div>
                    <div class="item">
                        <img src="<?= base_url() ?>template/tema1/images/portfolio/training/1.jpg" alt="">
                    </div>
                    <div class="item">
                        <img src="<?= base_url() ?>template/tema1/images/portfolio/training/3.jpg" alt="">
                    </div>
                    <div class="item">
                        <img src="<?= base_url() ?>template/tema1/images/portfolio/training/rajin.jpg" alt="">
                    </div>
                    <div class="item">
                        <img src="<?= base_url() ?>template/tema1/images/portfolio/training/rapi.jpg" alt="">
                    </div>
                    <!-- <div class="item">
                        <img src="<?= base_url() ?>template/tema1/images/portfolio/training/resikk.jpg" alt="">
                    </div> -->
            ...
            <div class="col-sm-5 col-md-5 portfolio-block">
                ...
                <ul class="project-general-info">
                    <li><p><i class="fa fa-user"></i> Materi Training</p></li>
